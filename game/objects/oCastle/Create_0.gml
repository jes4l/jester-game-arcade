...
// Create enemies
var enemy1 = instance_create_layer(x, y, "Instances", oEnemy);
var enemy2 = instance_create_layer(x, y, "Instances", oEnemyGhost);
var enemy3 = instance_create_layer(x, y, "Instances", oEnemyHomelander);
